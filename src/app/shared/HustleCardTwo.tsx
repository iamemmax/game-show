...
titleContainer,
    ...
    return (
        <article className={cn("relative group flex flex-col rounded-2xl w-full h-full overflow-hidden", className)}>
            ...
            <div className="absolute inset-0 flex w-full flex-col justify-between z-20 p-3">
                {/* Title at top */}
                <div
                    className={cn("text-3xl text-white w-full font-bold  flex justify-center items-center text-center  line-clamp-2",titleContainer )}
                ...
                >
                    {/* <h2  className="w-full font-bold font-gilroyHeavy "  style={{ WebkitTextStroke: "1.2px black" }}>{title}</h2> */}
                     ...
                     <GlowyStrokeText
                                          ...
                                          glowColor="#13051E"
                                          glowIntensity="low"
                                          textclassName={cn(`text-[1.8rem]  font-extrabold font-gilroyHeavy [@media(min-width:2000px)]:text-[5rem]`,titleClassName)}
                                          fillColor="#fff"
                                        >
                                          {title}
                                        </GlowyStrokeText>
                ...
                <div className="flex flex-col items-center justify-center flex-1 -mt-2">
                    ...
                    >
                     ...
                     <GlowyStrokeText
                                          ...
                                          glowColor="#13051E"
                                          glowIntensity="low"
                                          textclassName={cn("text-[1rem] font-extrabold font-verdana [@media(min-width:2000px)]:text-[5rem]",numberClassName)}
                                          fillColor="#fff"
                                        //   className={cn}
                                        >
                                           {number}
                     ...
                     <GlowyStrokeText
                                          ...
                                          glowColor="#13051E"
                                          glowIntensity="low"
                                          textclassName={cn("text-[1rem] font-extrabold font-gilroyHeavy [@media(min-width:2000px)]:text-[5rem]",amountClassName)}
                                          fillColor="#fff"
                                        //   className={cn}
                                        >
                                          {amount}
