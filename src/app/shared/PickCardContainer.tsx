...
// import PickCard1 from "../icons/cards/PickCard1";
// import PickCard2 from "../icons/cards/PickCard2";
// import PickCard3 from "../icons/cards/PickCard3";
// import PickCard4 from "../icons/cards/PickCard4";
...
const PickCardContainer: React.FC<PickCardContainerProps> = ({
  ...
  return (
    <div
      className={cn(
        "w-[220px] h-[240px] rounded-xl flex flex-col overflow-hidden",
        className
      )}
    ...
    >
      ...
      {containerLabel && (
        <div
          className={cn(
            "w-full py-2 text-center text-sm font-bold",
            labelClassName
          )}
          style={{
            color: labelColor,
      ...
      <div className="flex-1 flex items-center justify-center">
        {typeof text === "string" ? (
          ...
          <div className={cn("select-none", textClassName)}>{text}</div>
        )}
      </div>
    </div>
  );
