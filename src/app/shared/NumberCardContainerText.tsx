...
const NumberCardContainer: React.FC<ZtCardProps> = ({
  ...
  const textGradientId = `text_gradient_${uniqueId}`;
  ...
  return (
    ...
    >
      ...
      {/* Text with better stroke rendering */}
      {/* First draw the stroke as the background text */}
      <text 
        x="33"
        y="38"
        fontSize="18"
      ...
      {/* Then draw the text fill on top */}
      <text 
        x="33"
        y="38"
        fontSize="18"
