...
export interface ZtCardProps {
  ...
  iconSize?: number;
  status?: "correct" | "error" | "default"; // NEW status prop
}
...
const NumberCardContainer: React.FC<ZtCardProps> = ({
  ...
  const getStatusColors = () => {
    if (status === "correct") {
      return {
        primaryGradientStartColor: "#04DA6A",
        primaryGradientEndColor: "#04DA6A",
        secondaryGradientStartColor: "#04DA6A",
        secondaryGradientMiddleColor: "#04DA6A",
      ...
      return {
        primaryGradientStartColor: "#EB001B",
        primaryGradientEndColor: "#EB001B",
        secondaryGradientStartColor: "#EB001B",
        secondaryGradientMiddleColor: "#EB001B",
    ...
    return {
      primaryGradientStartColor: props.primaryGradientStartColor ?? "#7E3CE0",
      primaryGradientEndColor: props.primaryGradientEndColor ?? "#3C1272",
      secondaryGradientStartColor:
        props.secondaryGradientStartColor ?? "#7E3CE0",
      secondaryGradientMiddleColor:
        props.secondaryGradientMiddleColor ?? "#760F1B",
      secondaryGradientEndColor: props.secondaryGradientEndColor ?? "#3C1272",
      bgBlurColor: props.bgBlurColor ?? "#280458",
      centerBackgroundColor: props.centerBackgroundColor ?? "transparent",
  ...
  return (
    ...
    >
      ...
      />
      {centerBackgroundColor !== "transparent" && (
        <circle cx="33" cy="38" r="16" fill={centerBackgroundColor} />
      )}
      <path
      ...
      <defs>
        ...
        {!active && (
          <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop stopColor={props.tertiaryGradientStartColor ?? "#CE64FF"} />
            <stop
              offset="0.5"
              stopColor={props.tertiaryGradientMiddleColor ?? "#EB001B"}
            />
            <stop
              offset="1"
              stopColor={props.tertiaryGradientEndColor ?? "#7B3C99"}
            />
          </linearGradient>
        )}
      </defs>
