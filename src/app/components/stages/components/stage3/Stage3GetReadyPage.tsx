            ...
            >
              ...
              <div className="relative flex flex-col items-center w-full">
                ...
                >
                  ...
                  >
                    <GlowyStrokeText
                      className="text-[3rem] font-extrabold font-lucky"
                      glowColor="D91FFF"
                      glowIntensity="low"
                      fillColor="black"
                      strokeColor="#d91fff"
               ...
               <motion.ul
        className="list-disc text-sm text-white font-outfit pl-6 leading-[1.5rem] space-y-2"
        variants={containerVariants}
        initial="hidden"
        animate="visible"
        exit="exit"
      >
        ...
        <motion.li variants={listItemVariants}>
          The first to find the PASS card receives a Bonus Cash Boost and advances to the Final Stage.
                  ...
                  <motion.h3
                    className="text-2xl font-bold text-white mt-1 font-outfit"
                    variants={itemVariants}
                  >
                    Consolation Prize
                  </motion.h3>
                  ...
                  <motion.p
                    className="text-base font-outfit  font-semibold text-[#d91fff]"
                    variants={itemVariants}
                  >
                    Liberty Life Health Plan worth ₦369,000
                  </motion.p>

                  <motion.div className="mt-1" variants={itemVariants}>
                    <h3 className="text-2xl font-bold text-white mb-2">
                      Key Tips:
                    </h3>
                    <motion.ul
                      className="list-disc pl-6 leading-[2rem] text-sm text-white font-outfit"
                      variants={itemVariants}
                    >
                      {[
