    ...
    <div className="grid grid-cols-[1fr_5fr_1fr] h-full">
      ...
      <div className="flex justify-start flex-col items-center">
        ...
        <div className="flex justify-center w-full">
          <div className="border-[9px] border-[#d91fff] w-full py-[1rem]   2xl:py-[3rem] max-2xl:max-w-[46.5rem] rounded-[.875rem]  2xl:px-[3rem] bg-[#13051E] -mt-3">
            <div className="flex  justify-center flex-col items-center">
              ...
              <div className="flex mt-4 items-center gap-[1.375rem]">
                <div className="flex bg-black rounded-10 gap-4 px-[1.125rem] pr-[5rem] items-center py-4">
                  ...
                  <div className="">
                    <p className="text-white font-normal text-sm font-gilroyMedium">
                      Demola
                    </p>
                    <h2 className="text-base font-medium font-gilroyMedium text-white outline-text-white-2">
                      Player 1
                    </h2>
                  </div>
                </div>
