...
const Hustle = () => {
  return (
    <div className='grid grid-cols-[1fr_5fr_1fr] h-full'>
        <div className="  flex flex-col justify-between pt-[1.4375rem]">
...
<div className="flex flex-col  justify-center items-center">
  ...
  <p className=' max-w-[100px] text-center mt-2  font-bold text-xs text-white'>Hustle: Fashion Designer</p>
</div>
</div>
        ...
        <div className="border-[9px] border-[#d91fff] w-full py-[1rem]   max-xl:max-w-[45rem] 2xl:py-[3rem] max-w-[40.25rem] rounded-[.875rem] max-xl:px-[2rem] 2xl:px-[3rem] bg-[#13051E] -mt-3">
          <div className="flex  justify-center flex-col items-center">
            ...
            <div className="flex mt-4 items-center gap-[1.375rem]">
              <div className="flex bg-black rounded-10 gap-4 px-[1.125rem] py-2">
                 <div className="relative h-[2.8rem] w-[2.8rem] bg-[#bf7222] border-[5px] border-[#dba531] rounded-full overflow-hidden">
                            ...
                            <div className="">
                              <p className='text-white font-medium font-display'>Demola</p>
                              <h2 className='text-lg font-medium outline-text-white-2'>Player 1</h2>
                            </div>
              </div>
              <div className="flex bg-black rounded-10 gap-4 px-[1.125rem] py-2">
                 <div className="relative h-[2.8rem] w-[2.8rem] bg-[#bf7222] border-[5px] border-[#dba531] rounded-full overflow-hidden">
