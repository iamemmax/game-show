                      ...
                      {mqttQuestionData?.spend_breakdown?.slice(0, 3).map((spend: ContestantSpend) => {
                        ...
                        return (
                          <div
                            ...
                            className={`text-left py-4 px-3  w-full rounded-10 transition-all duration-300 ${isAnswerOptionSelected
                          ...
                          >
                              ...
                              {Object.entries(spend.spend_breakdown).map(([amount, value], index) => {
                                ...
                                return (
                                  <div
                                    ...
                                    className={`rounded-lg px-3 py-2 text-2xl font-gilroyHeavy transition-all ${isBidSelected
                            ...
                            {selectedBid && potentialWinning > 0 && (
                              ...
                              >
                                <div
                                  className={`text-lg font-gilroyMedium transition-all ${isAnswerOptionSelected
                                ...
                                <div className={`text-lg font-gilroyHeavy font-bold transition-all ${isAnswerOptionSelected
