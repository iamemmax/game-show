              ...
              <section className="bg-[#341D44] p-5 rounded-xl">
                <div>
                  <div className="rounded-lg space-y-3">
                    <div>
                      <div className="text-[0.65rem] text-[#878787] mb-1">Episode Name</div>
                      <div className="font-medium text-[0.825rem]">The Hustle S1</div>
                    </div>
                    <div>
                      <div className="text-[0.65rem] text-[#878787] mb-1">Status</div>
                    ...
                    <div>
                      <div className="text-[0.65rem] text-[#878787] mb-1">Current Stage</div>
                  ...
                  <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-2">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-[0.7rem] text-[#878787]">Contestant Name</FormLabel>
                            <FormControl>
                              <Input
                                {...field}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-[0.7rem] text-[#878787]">Phone Number</FormLabel>
                            <FormControl>
                              <Input
                                {...field}
                        ...
                        <div className="relative z-10 p-4 h-full flex flex-col justify-between">
                          <div className="flex items-start gap-3">
                            <div className="relative">
                              {isAssigned ? (
                                <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-[#ff00ff]">
                                  <img
                                ...
                                <div className="w-10 h-10 rounded-full flex items-center justify-center">
                                  <User className="h-5 w-5 text-[#ff00ff]" />
                                </div>
                              )}
                            </div>
                            <div>
                              <div className="text-xs text-[#878787]">
                                {isAssigned ? contestant.name : "Unassigned"}
                              </div>
