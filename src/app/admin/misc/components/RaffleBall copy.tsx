...
export function Ball({ number, variant = "regular", size = "md", onClick, className, textClassName, ...props }: BallProps) {
    const sizeClasses = {
        sm: "w-8 h-8",
        md: "w-10 h-10",
        lg: "w-16 h-16",
    ...
    const extraTextClass = cn("font-semibold font-montserrat", size == "sm" ? "text-base"
        :
        size == "md" ? "text-lg"
            : "text-lg")
    return (
                    ...
                    <>
                        ...
                        {number && (
                            <div className="absolute inset-0 flex items-center justify-center">
                                <span className={cn("text-white font-montserrat font-semibold ",
                                    textClassName, extraTextClass
                                )}
                                >
                                    {number}
                                </span>
                                ...
                                <defs>
                                    ...
                                    >
                                        ...
                                        <feBlend
                                            mode="normal"
                                            in2="shape"
                                            result="effect1_innerShadow_2298_771"
                                        />
                                        <feColorMatrix
                                            in="SourceAlpha"
                                            type="matrix"
                                        ...
                                        <feBlend
                                            mode="normal"
                                            in2="effect1_innerShadow_2298_771"
                                            result="effect2_innerShadow_2298_771"
                                        />
                                    </filter>
                                    <linearGradient
                                ...
                                <svg viewBox="0 0 38 39" fill="none" xmlns="http://www.w3.org/2000/svg" className={baseClasses} {...props}>
                                    <g filter="url(#filter0_ii_2260_2030)">
                                        <circle
                                            ...
                                            cy={18.9854}
                                            r={18}
                                            fill="url(#paint0_linear_2260_2045)"
                                        />
                                        <path
                                            d="M28.3105 9.1123L29.9717 8.19636L31.8486 10.3593L31.3061 12.4242L28.3105 9.1123Z"
                                            fill="white"
                                    ...
                                    <defs>
                                        ...
                                        >
                                            ...
                                            <feBlend
                                                mode="normal"
                                                in2="shape"
                                                result="effect1_innerShadow_2260_2045"
                                            />
                                            <feColorMatrix
                                                in="SourceAlpha"
                                                type="matrix"
                                            ...
                                            <feBlend
                                                mode="normal"
                                                in2="effect1_innerShadow_2260_2045"
                                                result="effect2_innerShadow_2260_2045"
                                            />
                                        </filter>
                                        <linearGradient
                                ...
                                <svg viewBox="0 0 38 39" fill="none" xmlns="http://www.w3.org/2000/svg" className={baseClasses} {...props}>
                                    <g filter="url(#filter0_ii_2260_2030)">
                                        <circle
                                            ...
                                            cy={18}
                                            r={18}
                                            fill="url(#paint0_linear_2260_2030)"
                                        />
                                        <path
                                            d="M28.3105 9.1123L29.9717 8.19636L31.8486 10.3593L31.3061 12.4242L28.3105 9.1123Z"
                                            fill="white"
                                    ...
                                    <defs>
                                        ...
                                        >
                                            ...
                                            <feBlend
                                                mode="normal"
                                                in2="shape"
                                                result="effect1_innerShadow_2260_2030"
                                            />
                                            <feColorMatrix
                                                in="SourceAlpha"
                                                type="matrix"
                                            ...
                                            <feBlend
                                                mode="normal"
                                                in2="effect1_innerShadow_2260_2030"
                                                result="effect2_innerShadow_2260_2030"
                                            />
                                        </filter>
                                        <linearGradient
