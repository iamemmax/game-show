...
export default function HostStage1Questions({
  ...
  const [currentQuestionData, setCurrentQuestionData] =
    useState<IGetHustleQuestionAPIResponse | null>(null);
  ...
  const {
    ...
    currentQuestionData?.data.question.question.question_id
  );
  ...
  React.useEffect(() => {
    if (questionResultData && !isLoadingQuestionResultData) {
      sendGameMessage("game_s1_question_answer", {
        question_id:
          currentQuestionData?.data.question.question.question_id.toString(),
    ...
    refetchQuestionResultData,
    questionResultData,
    isLoadingQuestionResultData,
  ]);
    ...
    <div className="w-full max-w-3xl mx-auto font-montserrat">
      {loading || isLoadingQuestionResultData ? (
        ...
        <div className="flex flex-col items-center justify-center mt-8">
          <TrapeziumButton
            onClick={handleRevealStage1Result}
            variant="purple"
            ...
            <header className="flex justify-between items-center gap-6 mb-4">
              <section className="flex items-center gap-2">
                ...
                <p className="text-white text-xs">
                  ...
                  <span className="text-[#ff00ff] font-medium ">
                    {
                      currentQuestionData.data.question.contestant
                        .contestant_name
                    }
                  </span>
                </p>
              ...
              <div className="bg-[#ff00ff]/20 rounded-full px-2 py-0.5 text-sm  shrink-0 ">
                <GlowyStrokeText glowIntensity="none">
                  Booster:{" "}
                  {currentQuestionData.data.question.question.question_booster}
                </GlowyStrokeText>
              </div>
            </header>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-[#462B58] px-4 py-2.5 rounded-xl text-sm">
                ...
                <span className="text-white">
                  {currentQuestionData.data.question.question.option_a}
                </span>
                <span>
                  {currentQuestionData.data.question.question.correct_option ===
                    "A" && (
              ...
              <div className="bg-[#462B58] px-4 py-2.5 rounded-xl text-sm">
                ...
                <span className="text-white">
                  {currentQuestionData.data.question.question.option_b}
                </span>
                <span>
                  {currentQuestionData.data.question.question.correct_option ===
                    "B" && (
              ...
              <div className="bg-[#462B58] px-4 py-2.5 rounded-xl text-sm">
                ...
                <span className="text-white">
                  {currentQuestionData.data.question.question.option_c}
                </span>
                <span>
                  {currentQuestionData.data.question.question.correct_option ===
                    "C" && (
              ...
              <div className="bg-[#462B58] px-4 py-2.5 rounded-xl text-sm">
                ...
                <span className="text-white">
                  {currentQuestionData.data.question.question.option_d}
                </span>
                <span>
                  {currentQuestionData.data.question.question.correct_option ===
                    "D" && (
      ...
      <div className="flex justify-center mt-6">
        {!loading && currentQuestionData && !questionsExhausted && (
          <>
            ...
            lastAction == "game_" ? (
              <TrapeziumButton
                onClick={() => refetchQuestionResultData()}
                variant="purple"
                data-remote-target="true"
              >
