...
const postNotifyBackendSTartTimer = async (data: RootObject) => {
  const res = await tokenlessAxios.post(
    "/api/admin-controller/question_start_time/",
    data
  );
  return res.data;
};
...
const postNotifyBackendEndTimer = async ({
  question_id,
  stage,
  timestamp,
}: {
  ...
  const endpoint =
    stage === "2"
      ? "/api/admin-controller/s2_question_time_elapsed/"
      : "/api/admin-controller/s1_question_time_elapsed/";
...
const postGetHustleQuestion = async ({
  episode,
}: {
  episode: string | number;
}) => {
  const res = await tokenlessAxios.post<IGetHustleQuestionAPIResponse>(
    `/api/admin-controller/request_hustle_reveal_question/${episode}`
  );
  return res.data;
};
...
const getHustleQuestionResult = async ({
  question_id,
}: {
  question_id: string | number;
}) => {
  const res = await tokenlessAxios.get<IGetHustleQuestionAPIResponse>(
    `/api/admin-controller/hustle_question_tally/${question_id}`
  );
  return res.data;
};
...
const getProofQuestionResult = async ({
  question_id,
}: {
  question_id: string | number;
}) => {
  const res = await tokenlessAxios.get<IGetHustleQuestionAPIResponse>(
    `/api/admin-controller/proof_hustle_question_tally/${question_id}`
  );
  return res.data;
};
...
const postStartGame = async ({
  ...
  const res = await tokenlessAxios.post(
    `/api/admin-controller/start_game_episode/${game_episode}`
  );
  return res.data;
};
...
const postEndStageOne = async ({ episode }: { episode: string | number }) => {
  const res = await tokenlessAxios.post<IGetHustleQuestionAPIResponse>(
    `/api/admin-controller/end_stage_one/${episode}`
  );
  return res.data;
};
...
const postInitStageTwo = async (data: { game_episode: string | number }) => {
  const res = await tokenlessAxios.post<IGetHustleQuestionAPIResponse>(
    `/api/admin-controller/init_stage_two/`,
    data
  );
  return res.data;
};
...
const postGetProofQuestion = async ({
  episode,
}: {
  episode: string | number;
}) => {
  const res = await tokenlessAxios.post<IGetProofQuestionAPIResponse>(
    `/api/admin-controller/request_proof_hustle_question/${episode}`
  );
  return res.data;
};
...
const postEndStageTwo = async ({ episode }: { episode: string | number }) => {
  const res = await tokenlessAxios.post<IGetHustleQuestionAPIResponse>(
    `/api/admin-controller/end_stage_two/${episode}`
  );
  return res.data;
};
...
export const getAllState2Questions = async (episode_id: number) => {
  ...
  const response = await tokenlessAxios.post(
    `api/game/get_all_proof_questions/${episode_id}?asked=false&won=false`
  );
...
const postInitStageThree = async (data: { game_episode: string | number }) => {
  const res = await tokenlessAxios.post<IGetHustleQuestionAPIResponse>(
    `/api/admin-controller/init_stage_three/${data.game_episode}`,
    data
  );
  return res.data;
};

export const useInitStage3 = () => {
  return useMutation({
    mutationFn: postInitStageThree,
    mutationKey: ["initialize-stage-3"],
  });
};

const postEndStageThree = async ({ episode }: { episode: string | number }) => {
  const res = await tokenlessAxios.post<IGetHustleQuestionAPIResponse>(
    `/api/admin-controller/end_stage_three/${episode}`
  );
  return res.data;
};
...
///////////             STAGE FOUR         ///////////////
//////////////////////////////////////////////////////////
const startStageFour = async ({
  episode,
  round_four_type,
}: {
  episode: string | number;
  round_four_type: string;
}) => {
  const res = await tokenlessAxios.post<IGetHustleQuestionAPIResponse>(
    `/api/admin-controller/init_final_stage`,
    {
