...
//           transition={{ duration: 0.5, delay: contestantIdx * 0.1 }}
//         >
//           {/* Contestant Card - Purple card style */}
//           <motion.div 
//             className="aspect-video bg-[#1C0240] border border-[#7E3CE0] rounded-lg py-3 px-4 flex-shrink-0 flex flex-col justify-between relative overflow-hidden"
//             initial={{ scale: 0.8, opacity: 0 }}
//             animate={{ scale: 1, opacity: 1 }}
//             transition={{ duration: 0.6, delay: contestantIdx * 0.1 }}
//           >
...
//                   initial={{ scale: 0 }}
//                   animate={{ scale: 1 }}
//                   transition={{ duration: 0.5, delay: contestantIdx * 0.1 + 0.3 }}
//                 >
//                   <Image
//                     alt=""
...
//                   transition={{ duration: 0.5, delay: contestantIdx * 0.1 + 0.4 }}
//                 >
...
//                   initial={{ opacity: 0, x: -20 }}
//                   animate={{ opacity: 1, x: 0 }}
//                   transition={{ duration: 0.5, delay: contestantIdx * 0.1 + 0.5 }}
//                 >
//                   ₦{addCommasToNumber(
