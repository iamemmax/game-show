...
//  const correctOption = currentQuestion?.question?.questions?.correct_option;
...
//         >
//           <div className={`${correctOption?.toLowerCase() === getOptionValue(currentQuestion?.question.questions,String(data?.answer?.toLowerCase()) )
...
function isAnswerCorrect(
  ...
  const correctAnswer = getOptionValue(questions, correctOption?.toLowerCase());
  const userAnswerValue = getOptionValue(questions, userAnswer?.toLowerCase());
  return correctAnswer === userAnswerValue && userAnswer !== "N";
}

// Sort contestants: correct answers first, then incorrect/no answers
function sortContestants(data: Data[], correctOption: string, questions: any): Data[] {
  return [...data].sort((a, b) => {
    const aCorrect = isAnswerCorrect(correctOption, a.answer, questions);
    const bCorrect = isAnswerCorrect(correctOption, b.answer, questions);
    
    // If both correct or both incorrect, maintain original order
